            ...
            <div id="form">
                ...
                <form method="post" action="parametros.php">
                    ...
                    <div class="input">
                        ...
                        <input id="email" name="email" placeholder="Mencione o seu email" type="text">
                    </div>
                    <label for="pais">País</label>
                    <div class="input">
                        <i class="fa-solid fa-location-dot" aria-hidden="true"></i>
                        <input id="pais" name="pais" placeholder="Mencione de onde fala connosco" type="text">
                    </div>

                    <label for="materia">Matéria que deseja</label>
                    <div class="input">
                        <i class="fa-solid fa-book-open"></i>
                        <input id="materia" name="materia" placeholder="Qual matéria deseja que postemos?" type="text">
                    </div>
