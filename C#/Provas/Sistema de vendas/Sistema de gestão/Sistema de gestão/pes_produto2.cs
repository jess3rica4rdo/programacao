...
{
    public partial class pes_produto2 : Form
    {
        ...
        public DataTable produto()
        {
            ...
            SqlDataAdapter apter = new SqlDataAdapter("SELECT cod_produto AS ID, nome_produto AS Nome, categoria AS Categoria, descricao AS Descrição, estado AS Estado, stock AS Estoque, preco_venda AS Preço_venda FROM produto", conn);
            apter.Fill(dt);
            return dt;
        }
        ...
        private void dgvproduto_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (iRow >= 0 && iColum > 0)
            {
                cproduto = new produto()
                {
                    ...
                    descricao = dgvproduto.Rows[iRow].Cells[3].Value.ToString(),
                    estado = dgvproduto.Rows[iRow].Cells[4].Value.ToString(),
                    stock = dgvproduto.Rows[iRow].Cells[5].Value.ToString(),
                    preco_venda = dgvproduto.Rows[iRow].Cells[6].Value.ToString()
                };
        ...
        private void ca_produto2_Load(object sender, EventArgs e)
        {
