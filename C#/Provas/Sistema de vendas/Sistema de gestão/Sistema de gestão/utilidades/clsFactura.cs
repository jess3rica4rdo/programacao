...
namespace Sistema_de_gestão.utilidades
{
    class clsFactura
    {
        public class CreaTicket
        {
            ...
            {
                string LineEncavesado = "      Dados da compra      ";   // agrega lineas de  encabezados
            ...
            public void TextoIzquierda(string par1)                          // agrega texto a la izquierda
            {
                ...
                {
                    cort = max - 80;
                    parte1 = par1.Remove(80, cort);        // si es mayor que 40 caracteres, lo corta
                }
                else { parte1 = par1; }                      // **********
