...
namespace SIG_FARMACIA
{
    public partial class principal : Form
    {
        ...
        {
            SqlConnection Con = new SqlConnection(@"Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=SIG_FARMA;Data Source=DESKTOP-QJSJVU3\SQLEXPRESS");
